// ===========================================================================
// Импорт внешних источников разметки
// ===========================================================================
import {
...
} from "./hygiene/index.js?v=2026-02-18-v.1";
...
import {
  ...
  shopLotsAntiSmells,
  shopLotsBathBombs
} from "./household_chemicals/index.js?v=2026-02-18-v.1";
...
} from "./household_products/index.js?v=2026-02-10-v.1";
...
function handleFormSubmit(event) {
  ...
  if (filteredCleaningWetWipes.length > 0) {
    ...
    SectionAllCleaningWipes.style.display = "none";
  }
